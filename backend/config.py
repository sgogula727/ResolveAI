...
class Settings(BaseSettings):
    ...
    vector_dim: int = Field(1024, env="VECTOR_DIM")
    ...
    mistral_chat_model: str = Field("mistral-small-latest", env="MISTRAL_CHAT_MODEL")
    mistral_embedding_model: str = Field("mistral-embed", env="MISTRAL_EMBEDDING_MODEL")
